...
<div id="frm_account" class="col-xs-12" style="text-align: center;">
    <form class="form form-horizontal" id="form1">
        ...
        <div class="col-xs-12 row cl">
            <label class="form-label col-xs-3 col-sm-3">填漫画的对应ID：</label>
        ...
        <div class="col-xs-12 row cl" style="text-align: center;">
            <div class="formControls col-xs-12 col-sm-12">
                <input type="button" onclick="scanmanhua()" class="btn btn-primary" value="扫描入库" id="btn_add_ok" />
            </div>
        </div>
...
<script>
    function scanmanhua() {
        ...
        $.ajax({
            type:"post",
            url:"/backend/manhua/deal",
            dataType:'json',
            headers:{'X-CSRF-TOKEN':$('input[name="_token"]').val()},
            data:{'manhua_id':manhua_id},
