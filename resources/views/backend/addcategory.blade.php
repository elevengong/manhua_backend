    ...
    <form class="form form-horizontal" id="form1">
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="" id="c_name" name="c_name" />
            </div>
        </div>
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <select name="parents_id" style="float:left;" id="parents_id">
                    ...
                    <option value="{{$category['cid']}}">{{$category['c_name']}}--添加到这个分类下</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="" id="priority" name="priority" />
            </div>
        </div>

        <div class="col-xs-12 row cl" style="text-align: center;">
            <div class="formControls col-xs-12 col-sm-12">
                <input type="button" onclick="addcategory()" class="btn btn-primary" value="添加分类" id="btn_add_ok" />
            </div>
        </div>
